...
public class DZBlue : MonoBehaviour
{
    ...
    public GameObject blueEye; // "Animation" Eyes
    ...
    {   
        if(collision.CompareTag("Player") && fg.flagActivate == false)
        {
           ...
           // Reset chaque blocs Inv Position + Sprite rendrer
            ...
            // Reset chaque blocs TEL OUT HitBox
    ...
    // Affiche l'image BlueEye
    public IEnumerator ActiveBlueEye() 
    {
        // Active RedEye
