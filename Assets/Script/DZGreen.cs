...
public class DZGreen : MonoBehaviour
{
    ...
    public GameObject greenEye; // "Animation" Eyes
    ...
    // Affiche l'image GreenEye
    public IEnumerator ActiveGreenEye() 
    {
        // Active RedEye
